              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-gray-500">
                    ...
                    {activity.type === 'appointment' && `${activity.meta.garage} â¢ ${{ pending: '×××ª××', confirmed: '××××©×¨', completed: '×××©××', cancelled: '××××', in_progress: '××××¦××¢' }[activity.meta.status] || activity.meta.status}`}
                    {activity.type === 'sos' && `${activity.meta.vehicle} â¢ ${{ open: '×¤×ª××', resolved: '×××¤×', closed: '×¡×××¨', pending: '×××ª××' }[activity.meta.status] || activity.meta.status}`}
                  </div>
                </div>
