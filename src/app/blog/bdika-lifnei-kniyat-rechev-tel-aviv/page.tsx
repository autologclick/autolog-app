    ...
    <div className="min-h-screen bg-[#F3F6FA]" dir="rtl">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">למה בכלל צריך בדיקה במכון?</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מכוני בדיקה מובילים בתל אביב והסביבה</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">1. קומפיוטסט תל אביב</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">2. דינמומטר (יד אליהו)</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">3. טכנו טסט תל אביב (סניף אנילביץ)</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
            <li><strong>מחיר:</strong> 750-950 ש&quot;ח</li>
            <li><strong>התמחות:</strong> חשמליים — בדיקת סוללה ייחודית</li>
          </ul>

          <h3 className="text-xl font-bold text-[#1B4E8A]">4. נבדקי רכב + PT Motors</h3>
          <p>אופציות נוספות, מחיר 650-850 ש&quot;ח, שירותים מקיפים.</p>

          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">כמה עולה בדיקת רכב לפני קנייה בתל אביב?</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מה כוללת בדיקה במכון?</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">בדיקה ויזואלית מקיפה</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
            <li>מצב הצבע — לזיהוי צביעה לאחר תאונה</li>
            <li>בדיקת ריתוכים ושלמות מבנה</li>
            <li>מצב פנים הרכב, ריפודים, מסכים</li>
            <li>בדיקת תחתית הרכב, הצירים והבלמים</li>
          </ul>

          <h3 className="text-xl font-bold text-[#1B4E8A]">בדיקה ממוחשבת (סורק OBD)</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">נסיעת מבחן + בדיקות מכאניות</h3>
          <p>בלמים, צמיגים, מתלים, היגוי, רעידות, ביצועי מנוע וגיר.</p>

          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מה לעשות לפני שאתם מגיעים למכון</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">טעויות נפוצות בקניית רכב יד שנייה</h2>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h3 className="text-lg font-bold text-[#1B4E8A]">האם הבדיקה במכון היא ערובה?</h3>
          ...
          <h3 className="text-lg font-bold text-[#1B4E8A]">כמה זמן לוקחת בדיקה במכון?</h3>
          <p>בדיקה סטנדרטית לוקחת 60-90 דקות. בדיקה מורחבת עם נסיעת מבחן יכולה להגיע ל-2 שעות.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">האם אפשר לקבל את הדוח גם בכתב?</h3>
          <p>כן, חובה. כל מכון מקצועי מספק דוח כתוב מפורט בסיום הבדיקה.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">כמה ימים אחרי הבדיקה הקנייה צריכה להתבצע?</h3>
