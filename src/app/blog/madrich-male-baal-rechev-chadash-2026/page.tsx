    ...
    <div className="min-h-screen bg-[#F3F6FA]" dir="rtl">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="bg-teal-50 border border-teal-200 rounded-2xl p-6 mb-10">
          <h2 className="text-lg font-bold text-[#1B4E8A] mb-3">📑 תוכן עניינים</h2>
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          {/* INTRO */}
          <h2 id="introduction" className="text-2xl font-bold text-[#1B4E8A] pt-4 scroll-mt-20">1. פתיחה — ברוכים הבאים לעולם בעלי הרכב</h2>
          ...
          {/* PURCHASE */}
          <h2 id="purchase" className="text-2xl font-bold text-[#1B4E8A] pt-8 scroll-mt-20">2. קניית הרכב — איך לקנות נכון</h2>
          <p>
            קניית רכב היא אחת ההחלטות הפיננסיות הגדולות ביותר. במחיר ממוצע של 60,000-200,000 ש&quot;ח, טעות יכולה לעלות אלפים בתיקונים.
          </p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">חדש או יד שנייה?</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">צ&apos;קליסט קניית רכב יד שנייה</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">איפה לבדוק את הרכב לפי עיר</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">חשמלי, היברידי או בנזין?</h3>
          ...
          {/* REGISTRATION */}
          <h2 id="registration" className="text-2xl font-bold text-[#1B4E8A] pt-8 scroll-mt-20">3. רישום והעברת בעלות</h2>
          <p>אחרי קניית הרכב, חובה להעביר את הבעלות תוך <strong>10 ימים</strong>. אי-עמידה בזמן = קנס מנהלי + הבעלות נשארת רשומה על שם המוכר, מה שמפקיר אותו לקנסות ולתביעות.</p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">תהליך מהיר באינטרנט (15-20 דקות)</h3>
          ...
          {/* INSURANCE */}
          <h2 id="insurance" className="text-2xl font-bold text-[#1B4E8A] pt-8 scroll-mt-20">4. ביטוח — חובה ומקיף</h2>
          <p>אסור לנסוע בלי ביטוח חובה — חובה חוקית. ביטוח מקיף מומלץ לרכב חדש או יקר.</p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">ביטוח חובה</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">ביטוח מקיף</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">איך לחסוך אלפי שקלים על ביטוח</h3>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">לא לפספס תזכורות</h3>
          ...
          {/* TEST */}
          <h2 id="test" className="text-2xl font-bold text-[#1B4E8A] pt-8 scroll-mt-20">5. טסט שנתי — הכל מה שצריך לדעת</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">מה זה טסט?</h3>
          <p>בדיקה שנתית חובה במכון רישוי מורשה. בלי טסט בתוקף — אסור לנסוע, ויש קנסות כבדים.</p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">כמה זה עולה?</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">איך לדעת מתי הטסט הבא?</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">איך מתכוננים לטסט</h3>
          ...
          {/* MAINTENANCE */}
          <h2 id="maintenance" className="text-2xl font-bold text-[#1B4E8A] pt-8 scroll-mt-20">6. תחזוקה שוטפת</h2>
          <p>תחזוקה מונעת היא <strong>הדרך הזולה ביותר</strong> לשמור על הרכב. טיפול ב-650-900 ש&quot;ח חוסך תיקון של 5,000+ ש&quot;ח.</p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">לוח זמנים לתחזוקה</h3>
          <ul className="list-disc list-inside space-y-2 mr-4">
            <li><strong>כל 10,000-15,000 ק&quot;מ:</strong> טיפול תקופתי</li>
            <li><strong>כל 30,000-50,000 ק&quot;מ:</strong> מסנני אוויר, נוזל בלמים, נוזל קירור</li>
            <li><strong>כל 60,000 ק&quot;מ:</strong> בלמים מלאים</li>
            <li><strong>כל 80,000-100,000 ק&quot;מ:</strong> צמיגים</li>
          </ul>

          <h3 className="text-xl font-bold text-[#1B4E8A]">החלפת שמן — הכי חשוב</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">אבחון עצמי עם OBD2</h3>
          ...
          {/* EXPENSES */}
          <h2 id="expenses" className="text-2xl font-bold text-[#1B4E8A] pt-8 scroll-mt-20">7. ניהול הוצאות</h2>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">פילוח הוצאות חודשיות</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">12 דרכים לחסוך אלפי שקלים</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">למה כדאי לעקוב אחרי הוצאות?</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          {/* EMERGENCY */}
          <h2 id="emergency" className="text-2xl font-bold text-[#1B4E8A] pt-8 scroll-mt-20">8. מצבי חירום ותאונות</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">מה לעשות בתאונה?</h3>
          <ol className="list-decimal list-inside space-y-2 mr-4">
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">פגעו ברכב החונה — מה לעשות?</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">תקלה בדרך</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
            <li>חברת ביטוח מקיף — חייגו לגרירה</li>
            <li>אין מקיף — שירות גרירה של חברת הביטוח, שגריר, דרך ארץ, או חברה פרטית (50-300 ש&quot;ח)</li>
            <li>תקלה קלה — נסו לפתור עם אפליקציות (כמו עוזר AI ב-AutoLog)</li>
          </ul>

          {/* TOOLS */}
          <h2 id="tools" className="text-2xl font-bold text-[#1B4E8A] pt-8 scroll-mt-20">9. כלים שיהפכו אתכם לבעלי רכב חכמים</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">אפליקציה לניהול רכב</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">סורק OBD2</h3>
          <p>50-150 ש&quot;ח לסורק בלוטות&apos; פשוט. חוסך הרבה כסף בכך שמזהה תקלות מוקדם.</p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">אפליקציות השוואת מחירי דלק</h3>
          <p>Yellow, Pango Fuel — חוסכות 50-150 ש&quot;ח בחודש בקלות.</p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">מצלמת רכב (Dash Cam)</h3>
          <p>400-1,500 ש&quot;ח. מתעדת תאונות וגנבות. הוכחה ביטוחית חזקה.</p>

          {/* SUMMARY */}
          <h2 id="summary" className="text-2xl font-bold text-[#1B4E8A] pt-8 scroll-mt-20">10. סיכום וצעדים ראשונים</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">סיכום</h2>
          <p>
