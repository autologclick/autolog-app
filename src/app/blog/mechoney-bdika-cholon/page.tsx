      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          <ol className="list-decimal list-inside space-y-2 mr-4">
            ...
            <li><strong>מערכת קירור</strong> — לחות גבוהה בקיץ</li>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            ...
            { '@type': 'FAQPage', mainEntity: [
              { '@type': 'Question', name: 'איפה הכי זול לבדוק רכב בחולון?', acceptedAnswer: { '@type': 'Answer', text: 'סיטי סנטר טסט חולון או דינמומטר — סביב 350 ש"ח.' } },
              { '@type': 'Question', name: 'תושבי רמת גן — חולון או תל אביב?', acceptedAnswer: { '@type': 'Answer', text: 'חולון לרוב יותר זול ב-15-30 ש"ח ופחות עומס.' } },
            ] },
          ],
        }) }} />
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex items-center justify-between">
          ...
          <Link href="/blog/bituach-rechev-chova-madrich-male-2026" className="flex items-center gap-1 text-sm text-teal-600 font-semibold hover:text-teal-700 transition">ביטוח רכב חובה — מדריך מלא<ChevronLeft size={14} /></Link>
        </div>
      </article>
