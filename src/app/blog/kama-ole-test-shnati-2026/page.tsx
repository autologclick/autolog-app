      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          <ul className="list-disc list-inside space-y-2 mr-4">
            ...
            <li>רכב היברידי / חשמלי: הנחה משמעותית, לעיתים 50% מהסכום הרגיל</li>
          </ul>
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">איך תזכור מתי הטסט הבא?</h2>
          <p>
          ...
          <h3 className="text-lg font-bold text-[#1e3a5f]">האם אפשר לעשות טסט באיחור?</h3>
          <p>
            כן, מותר לבצע את הטסט בתוך 90 יום מתום תוקף הרישיון הקודם, אבל הרכב נחשב לא תקין במהלך התקופה הזו ואסור לנסוע בו.
            בנוסף, ייגבה קנס איחור של 200-500 ש&quot;ח.
          </p>

          <h3 className="text-lg font-bold text-[#1e3a5f]">מי פטור מטסט שנתי?</h3>
