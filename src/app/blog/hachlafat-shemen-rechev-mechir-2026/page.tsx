    ...
    <div className="min-h-screen bg-[#F3F6FA]" dir="rtl">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">למה החלפת שמן כל כך חשובה?</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מתי להחליף שמן 2026?</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">כמה עולה החלפת שמן 2026?</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">לפי סוג שמן (כולל פילטר ועבודה):</h3>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">לפי סוג רכב:</h3>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מה כולל המחיר?</h2>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">איך לבחור שמן נכון לרכב?</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">1. תבדקו במדריך הרכב</h3>
          <p>היצרן מציין במדויק את סוג השמן, הצמיגות (5W-30, 0W-20 וכו&apos;) והתקנים. אל תסטו מזה.</p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">2. לרכב חדש — שמן סינטטי מלא</h3>
          <p>כל רכב מ-2015 ומעלה מומלץ עם סינטטי מלא. עולה יותר אבל מחזיק יותר זמן.</p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">3. לרכב ישן (10+ שנים)</h3>
          <p>שמן מינרלי או חצי-סינטטי מתאים, ועולה פחות. סינטטי מלא ברכב ישן יכול לגרום לדליפות.</p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">4. צמיגות נכונה (Viscosity)</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">איך לחסוך על החלפת שמן</h2>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">סימני אזהרה — שמן צריך החלפה דחופה</h2>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מה לעשות אם פספסתם החלפה</h2>
          ...
          <h3 className="text-lg font-bold text-[#1B4E8A]">האם אפשר להחליף שמן בבית?</h3>
          <p>אפשר, אבל דורש כלים ומיומנות. רוב האנשים מעדיפים מוסך — חיסכון של 100 ש&quot;ח לא שווה את הסיכון.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">שמן מקורי יצרן או חליפי?</h3>
          <p>חליפי איכותי (Mobil, Castrol, Shell) טוב לא פחות מהמקורי, ולרוב זול ב-30-50%.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">מתי להחליף שמן בהיברידי?</h3>
          <p>פחות תכוף — בערך כל 15,000-20,000 ק&quot;מ או שנה. המנוע עובד פחות.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">חשמלי צריך החלפת שמן?</h3>
          <p>לא! ברכב חשמלי מלא אין מנוע בנזין ולכן אין שמן מנוע. יש שמן בגיר (לעיתים) — תחזוקה מינימלית.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">למה השמן שחור?</h3>
