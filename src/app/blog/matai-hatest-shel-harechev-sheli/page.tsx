    ...
    <div className="min-h-screen bg-[#fef7ed]" dir="rtl">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          <p>
            עלות הטסט הבסיסי נעה בין 200-350 שקלים, תלוי במכון הרישוי. אם הרכב נכשל ודורש בדיקה חוזרת, העלות נמוכה יותר (בדרך כלל 80-120 שקלים).
            חשוב לדעת: מכוני רישוי שונים גובים מחירים שונים, אז שווה להשוות.
          </p>
