    ...
    <div className="min-h-screen bg-[#fef7ed]" dir="rtl">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">1. שמור על לחץ אוויר תקין בצמיגים</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">2. הסר משקל מיותר מהרכב</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">3. הימנע מהמתנה ארוכה במנוע פועל</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">4. נהג בקצב קבוע</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">5. חפש את המהירות הכלכלית</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">6. השתמש במזגן בחוכמה</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">7. תכנן את הנסיעות מראש</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">10. עקוב אחרי הצריכה שלך</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">11. דלק נכון לרכב שלך</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">12. שקול חלופות לרכב</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">סיכום: כמה תחסוך באמת?</h2>
          <p>
          ...
          <h3 className="text-lg font-bold text-[#1e3a5f]">איזה הטיפ הכי אפקטיבי?</h3>
          <p>נהיגה בקצב קבוע, בלי תאוצות פתאומיות. החיסכון יכול להגיע ל-30%.</p>

          <h3 className="text-lg font-bold text-[#1e3a5f]">האם תוספים לדלק באמת עובדים?</h3>
          <p>במקרים מסוימים (מנוע ישן, ניקוי מצערת) — כן, חד-פעמי. כפתרון קבוע — בזבוז כסף.</p>

          <h3 className="text-lg font-bold text-[#1e3a5f]">דלק בנזין או דיזל — מה זול יותר?</h3>
          <p>דיזל זול לליטר, אבל רכבי דיזל יקרים יותר ויש להם תחזוקה יקרה. סה&quot;כ — בנזין ברוב המקרים זול יותר ל-5 שנים.</p>

          <h3 className="text-lg font-bold text-[#1e3a5f]">האם רכב היברידי באמת חוסך הרבה?</h3>
