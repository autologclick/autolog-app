      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          <p className="text-lg text-gray-600 font-medium">
            מכרת רכב? קנית רכב יד שנייה? כעת אתה צריך להעביר את הבעלות במשרד הרישוי. ב-2026 רוב התהליך דיגיטלי
            וניתן להשלים אותו תוך 15 דקות מהבית. במאמר תמצא מדריך מלא — מה לעשות, אילו מסמכים צריך, כמה זה עולה,
          ...
          <ul className="list-disc list-inside space-y-1 mr-4">
            ...
            <li>אישור על תשלום אגרת רישוי בתוקף</li>
            <li>אישור על ביטוח חובה בתוקף</li>
            <li>אישור על אין שעבודים (בדיקה אונליין באתר משרד התחבורה)</li>
          ...
          <ul className="list-disc list-inside space-y-1 mr-4">
            ...
            <li>פרטי הקונה ותעודת זהות</li>
            <li>תאריך העסקה ומחיר</li>
          ...
          <ol className="list-decimal list-inside space-y-2 mr-4">
            ...
            <li><strong>תעדו את כל מסמכי הרכב</strong> ב-AutoLog — חוסך זמן בעתיד</li>
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              '@graph': [
                ...
                {
                  '@type': 'HowTo',
                  name: 'איך להעביר בעלות על רכב בישראל 2026',
                  description: 'מדריך שלב אחר שלב להעברת בעלות על רכב באופן דיגיטלי',
                  step: [
                    { '@type': 'HowToStep', name: 'כניסה לאתר משרד התחבורה', text: 'היכנסו ל-gov.il עם הזדהות תעודת זהות' },
                    { '@type': 'HowToStep', name: 'מילוי הטופס', text: 'הזינו פרטי רכב, מוכר וקונה' },
                    { '@type': 'HowToStep', name: 'תשלום אגרה', text: 'שלמו 240 ש"ח בכרטיס אשראי' },
                    { '@type': 'HowToStep', name: 'קבלת אישור', text: 'האישור נשלח במייל מיד' },
                  ],
                },
                {
                  '@type': 'FAQPage',
                  mainEntity: [
                    { '@type': 'Question', name: 'כמה זמן לוקחת העברת בעלות אונליין?', acceptedAnswer: { '@type': 'Answer', text: '15-20 דקות אם כל המסמכים מוכנים. האישור מגיע מיד.' } },
                    { '@type': 'Question', name: 'מה עולה העברת בעלות 2026?', acceptedAnswer: { '@type': 'Answer', text: 'אגרת ההעברה היא סביבות 240 ש"ח.' } },
                    { '@type': 'Question', name: 'האם אפשר להעביר בעלות לקטין?', acceptedAnswer: { '@type': 'Answer', text: 'לא. רק מי שמלאו לו 18 יכול להיות בעל רכב רשום בישראל.' } },
                  ],
                },
              ],
            }),
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex items-center justify-between">
          ...
          <Link href="/blog/ma-livdok-lifnei-kniyat-rechev-yad-shniya" className="flex items-center gap-1 text-sm text-teal-600 font-semibold hover:text-teal-700 transition">
            צ&apos;קליסט קניית רכב יד שנייה<ChevronLeft size={14} />
          </Link>
        </div>
      </article>
