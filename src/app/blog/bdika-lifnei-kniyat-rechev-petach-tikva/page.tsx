    ...
    <div className="min-h-screen bg-[#F3F6FA]" dir="rtl">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מכוני בדיקה מומלצים בפתח תקווה</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">1. קומפיוטסט פתח תקווה</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">2. טכנו טסט פתח תקווה</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
            <li><strong>מחיר:</strong> 1,300-2,100 ש&quot;ח</li>
            <li><strong>התמחות:</strong> רכבים חשמליים, היברידיים</li>
          </ul>

          <h3 className="text-xl font-bold text-[#1B4E8A]">3. נבדקי רכב — סניף פתח תקווה</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
            <li><strong>מחיר:</strong> 640-820 ש&quot;ח</li>
            <li><strong>שירותים:</strong> בדיקה מלאה, כיווני פרונט, בדיקות חורף</li>
          </ul>

          <h3 className="text-xl font-bold text-[#1B4E8A]">4. PT Motors פתח תקווה</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
            <li><strong>מחיר:</strong> 620-770 ש&quot;ח (זול יחסית)</li>
            <li><strong>חניה חינם</strong></li>
          </ul>

          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">כמה עולה בדיקה בפתח תקווה?</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">דברים מיוחדים לבדוק ברכב מפתח תקווה</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">איך לבחור נכון</h2>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h3 className="text-lg font-bold text-[#1B4E8A]">איפה הכי זול לבדוק רכב בפתח תקווה?</h3>
          <p>PT Motors מציע מחירים החל מ-340 ש&quot;ח לרכב פרטי.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">האם יש מכוני בדיקה פתוחים בשעות הערב?</h3>
          <p>רוב המכונים סוגרים בין 17:00-17:30. הזמינו תור עד 16:00 לכל המאוחר.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">האם תושבי ראש העין יבואו לפתח תקווה?</h3>
          <p>כן. הנסיעה היא 10-15 דקות וזה כמעט תמיד מהיר יותר ממכוני ראש העין.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">כמה זמן לפני הקנייה כדאי לקבוע תור?</h3>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@graph': [
            ...
            { '@type': 'FAQPage', mainEntity: [
              { '@type': 'Question', name: 'איפה הכי זול לבדוק רכב בפתח תקווה?', acceptedAnswer: { '@type': 'Answer', text: 'PT Motors מציע מחירים החל מ-620 ש"ח לרכב פרטי.' } },
