    ...
    <div className="min-h-screen bg-[#F3F6FA]" dir="rtl">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">שלב 1: לפני שאתם יוצאים לראות את הרכב</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">בדיקות באינטרנט</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">בדיקת המוכר</h3>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">שלב 2: בדיקה ויזואלית של הרכב</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">חיצוני</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
            <li><strong>בדיקת צבע</strong> — אם בעמודי המוסך משתקפים גוונים שונים, יש סיכוי שהוא נצבע אחרי תאונה</li>
            <li><strong>מרווחים בין דלתות</strong> — אם המרווחים לא אחידים, היו תאונה ופירוק</li>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">תחתית הרכב</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">פנים הרכב</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">שלב 3: בדיקה ממוחשבת (OBD2)</h2>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">שלב 4: בדיקת המסמכים</h2>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">שלב 5: נסיעת מבחן</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">שלב 6: בדיקה במכון מקצועי</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">שלב 7: אחרי הקנייה</h2>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">דגלים אדומים — סימני אזהרה</h2>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h3 className="text-lg font-bold text-[#1B4E8A]">כמה שווה לי לבדוק רכב יד שנייה?</h3>
          <p>650-850 ש&quot;ח על בדיקה במכון. הסכום הזה יכול לחסוך לכם 5,000-50,000 ש&quot;ח.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">האם להעדיף רכב מסוחר או פרטי?</h3>
          <p>פרטי: לרוב זול ב-5-10%, אבל פחות אחריות. סוחר: יותר יקר אבל מקבל אחריות חוקית של 6 חודשים על תקלות סמויות.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">באילו דגמים יש פחות תקלות?</h3>
          <p>דגמי טויוטה, מאזדה, יונדאי ב-3-7 שנים האחרונות נחשבים אמינים. דגמים אירופאיים — יקרים יותר לתחזוקה.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">האם רכב היברידי שווה?</h3>
          <p>כן, אבל בדקו במיוחד את מצב הסוללה. החלפת סוללה היברידית יכולה לעלות 15,000-30,000 ש&quot;ח.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">מה עושים אם גילינו תקלה אחרי הקנייה?</h3>
