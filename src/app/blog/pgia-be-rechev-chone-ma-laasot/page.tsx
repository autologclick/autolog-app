    ...
    <div className="min-h-screen bg-[#F3F6FA]" dir="rtl">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מה החוק אומר?</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מה לעשות מיד כשמגלים נזק?</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">1. אל תזיזו את הרכב</h3>
          <p>אם זה אפשרי, השאירו את הרכב בדיוק איפה שהוא. צילומים יחזקו את התביעה.</p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">2. צלמו הכל</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">3. חפשו פתק</h3>
          <p>גם מתחת למגב, בתוך הרכב (אם פתוח), או על הפאנל הקדמי. נהגים הוגנים משאירים.</p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">4. חפשו עדים</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">5. דווחו למשטרה</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">6. דווחו לחברת הביטוח</h3>
          <p>תוך 24-48 שעות מגילוי הנזק. הם יסייעו בתהליך התביעה.</p>

          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מי משלם על הנזק?</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">תרחיש 1: יש לכם ביטוח מקיף</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">תרחיש 2: ביטוח חובה בלבד / צד ג&apos;</h3>
          <p>אם אין מקיף, החובה לא מכסה נזק לרכב. תשלמו מכיסכם — אלא אם תזהו את הפוגע.</p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">תרחיש 3: זוהה הפוגע</h3>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">איך מצמצמים את הנזק הכספי?</h2>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">איך למנוע את זה בעתיד?</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מה אם אני זה שפגעתי ברכב חונה?</h2>
          ...
          <h3 className="text-lg font-bold text-[#1B4E8A]">תוך כמה זמן צריך לדווח למשטרה?</h3>
          <p>תוך 24 שעות. אחרת המשטרה לא תפתח תיק.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">חברת הביטוח לא רוצה לכסות — מה לעשות?</h3>
          <p>פנו לעורך דין תעבורה או למוקד התלונות של רשות שוק ההון. רוב המקרים נפתרים.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">תקיפת מצלמת אבטחה בלי רשות — חוקי?</h3>
          <p>ראיית הקלטה מצלמה ציבורית — כן. אבל אם זו מצלמה פרטית — צריך הסכמה. חוקרים פרטיים יכולים לעזור.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">אם הנזק קטן — שווה לדווח?</h3>
          <p>אם זה פחות מההשתתפות העצמית — לא משתלם. אם יש סיכוי לזהות הפוגע — כן.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">מה זה &quot;נזק עיוור&quot;?</h3>
