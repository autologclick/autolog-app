    ...
    <div className="min-h-screen bg-[#fef7ed]" dir="rtl">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">סוגי ביטוח רכב — קצר וברור</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">על מה לשים לב בפוליסה</h2>

          <h3 className="text-xl font-bold text-[#1e3a5f]">1. השתתפות עצמית</h3>
          <p>הסכום שאתם משלמים מכיסכם בכל מקרה. בדרך כלל 1,500-3,000 ש&quot;ח. פוליסה זולה לרוב = השתתפות גבוהה.</p>

          <h3 className="text-xl font-bold text-[#1e3a5f]">2. ערך הרכב</h3>
          <p>במקרה אובדן מוחלט (טוטל לוס), כמה תקבלו? וודאו שזה ערך השוק (מחירון יד2 / לוי יצחק) ולא נמוך יותר.</p>

          <h3 className="text-xl font-bold text-[#1e3a5f]">3. מי יכול לנהוג ברכב?</h3>
          <p>פוליסה לנהג יחיד = זול. רחב יותר (כל בני המשפחה / כל נהג) = יקר יותר. בחרו לפי השימוש בפועל.</p>

          <h3 className="text-xl font-bold text-[#1e3a5f]">4. שירותים נלווים</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          <h3 className="text-xl font-bold text-[#1e3a5f]">5. מנגנון התביעה</h3>
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">איך לחסוך אלפי שקלים</h2>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h2 className="text-2xl font-bold text-[#1e3a5f] pt-4">סימני אזהרה — איזה ביטוח לא לקנות</h2>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h3 className="text-lg font-bold text-[#1e3a5f]">לרכב חדש — חובה לקחת מקיף?</h3>
          <p>חובה לא, אבל חכם כן. רכב חדש בשווי 100,000+ ש&quot;ח ראוי שיהיה מבוטח מקיף.</p>

          <h3 className="text-lg font-bold text-[#1e3a5f]">לרכב ישן (15+) — מקיף שווה?</h3>
          <p>בדרך כלל לא. ערך הרכב נמוך, ועלות הביטוח לא משתלמת. צד ג&apos; עדיף.</p>

          <h3 className="text-lg font-bold text-[#1e3a5f]">איך מוכיחים מקרה ביטוח?</h3>
          <p>תיעוד! צלם הכל בזירת התאונה, אסוף פרטי הצד השני, פנה למשטרה במקרה הצורך, ותעדו ב-AutoLog.</p>

          <h3 className="text-lg font-bold text-[#1e3a5f]">מה זה השתתפות עצמית?</h3>
          <p>הסכום שאתם משלמים מכיסכם לפני שהביטוח מתחיל לכסות. אם השתתפות 2,000 ש&quot;ח ונזק 5,000 ש&quot;ח — אתם משלמים 2,000, הביטוח 3,000.</p>

          <h3 className="text-lg font-bold text-[#1e3a5f]">תאונה ראשונה — תמיד מעלה את הביטוח?</h3>
