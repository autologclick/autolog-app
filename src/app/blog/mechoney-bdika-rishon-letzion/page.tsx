    ...
    <div className="min-h-screen bg-[#F3F6FA]" dir="rtl">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מכוני הבדיקה בראשון לציון — הרשימה המלאה</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">1. קומפיוטסט ראשון לציון</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">2. טכנו טסט ראשון לציון</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">3. נבדקי רכב — בדיקות ממוחשבות</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">4. PT Motors — סניף ראשון לציון</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">5-7. פרונט מוטורס, גריז, המומחים</h3>
          <p>אופציות נוספות במחירים 650-850 ש&quot;ח, שירותים מקיפים.</p>

          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מה הופך את ראשון לציון למיקום אטרקטיבי לבדיקה?</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">איך לבחור מכון בראשון לציון?</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מה כל מכון אמור לכלול בבדיקה?</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">טיפים מקומיים לתושבי ראשון לציון</h2>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h3 className="text-lg font-bold text-[#1B4E8A]">האם יש מכוני בדיקה הפתוחים ביום שישי בראשון לציון?</h3>
          <p>כן, רוב המכונים פועלים גם ביום שישי בבוקר (לרוב 7:30-12:30). הזמינו תור מראש כי השעות מצומצמות.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">מה עולה בדיקה בראשון לציון לעומת תל אביב?</h3>
          <p>בראשון 10-20% פחות, בממוצע 50-100 ש&quot;ח חיסכון על אותו סוג בדיקה.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">האם אפשר להזמין תור אונליין?</h3>
          <p>רוב המכונים הגדולים (קומפיוטסט, טכנו טסט) מאפשרים הזמנה אונליין עם הנחה של 5-10%.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">מהו מכון בדיקה הזול ביותר בראשון לציון?</h3>
          <p>PT Motors הוא לרוב הזול ביותר, עם בדיקה החל מ-350 ש&quot;ח.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">האם אפשר לעשות גם טסט שנתי באותו מכון?</h3>
              ...
              '@graph': [
                ...
                },
                {
                  ...
                  mainEntity: [
                    ...
                    { '@type': 'Question', name: 'מהו מכון בדיקה הזול ביותר בראשון לציון?', acceptedAnswer: { '@type': 'Answer', text: 'PT Motors הוא לרוב הזול ביותר, עם בדיקה החל מ-640 ש"ח.' } },
                  ],
                },
              ],
            }),
