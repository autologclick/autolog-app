    ...
    <div className="bg-white" dir="rtl">
              ...
              },
              {
                ...
                mainEntity: [
                  ...
                  },
                  {
                    ...
                    acceptedAnswer: {
                      '@type': 'Answer',
                      text: 'פרטיות ואבטחה הם עליפות מספר 1 שלנו. כל המידע מוצפן בסטנדרטים בנקאיים ומאוחסן בשרתים מאובטחים.',
                    },
                  },
                  {
                    '@type': 'Question',
      ...
      <section id="features" className="py-20 sm:py-28 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          </div> <h2 className="text-3xl sm:text-4xl font-extrabold text-[#1e3a5f] mb-4">
          ...
          <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <FeatureCard
              icon={FileText}
              title="אנטרור תורים"
              description='ביטוח, רישוי Ҁ� ׹ףנשפך מלא אנטומטית."
              delay={0}
            />
            <FeatureCard
              icon={Bell}
            ...
            <FeatureCard
              ...
              description="תזמן בדיקה או טיפול במוסך ישירות מהמערכת. ללא טלפון."
              delay={400}
            />
            <FeatureCard
              icon={BarChart3}
              title="המתאות אונליין"
              description="׋וררים וקוחות — היסטוריית טיפולים, ההוצאות והבדיקות לאורך חיי הרכב — מידע שעוזר גם במכירה."
              delay={500}
            />
          </div>
        </div>
      ...
      <section id="how-it-works" ref={howItWorks.ref} className="py-20 sm:py-28 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-teal-600 font-semibold text-sm mb-2 block">פשוט וקל</span>             <h2 className="text-3xl sm:text-4xl font-extrabold text-[#1e3a5f] mb-4">
              מתחילים בשלושה צעדים
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto">
              ללא הורדת אפליקציה. ללא כרטיס אשראי. פשוט נרשמים ומתחילים.
          ...
          <div class={`grid md:grid-cols-3 gap-8 transition-all duration-1000 ${howItWorks.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            {[
              { 
                num: '01',
                title: 'הרשמה מהירה',
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-4">
                ו7�לטפורמה המובילה בישראל לניהול רכבים חכם. כל המסמכים, התזכורות והשירותים שלך — במקום אחד.
              </p>
