    ...
    <div className="min-h-screen bg-[#F3F6FA]" dir="rtl">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מה זה בכלל OBD2?</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">איפה נמצא שקע ה-OBD2 ברכב?</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מה אפשר לעשות עם סורק OBD2?</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">1. קריאת קודי תקלה (DTC)</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">2. ניטור בזמן אמת</h3>
          <p>
            אפשר לראות סיבובי מנוע, טמפרטורת מנוע, צריכת דלק רגעית, מהירות, מתח סוללה, לחץ מנוע ועוד עשרות פרמטרים — בזמן אמת תוך כדי נסיעה.
          </p>

          <h3 className="text-xl font-bold text-[#1B4E8A]">3. מחיקת קוד התקלה</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">4. בדיקת מוכנות לטסט</h3>
          <p>לפני הגעה לטסט, סורק OBD יגיד אם הרכב &quot;מוכן&quot; לבדיקה (כל המערכות הראו תקינות לפחות פעם אחת מאז המחיקה האחרונה).</p>

          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">כמה עולה סורק OBD2?</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">איך משלבים OBD2 עם ניהול רכב חכם?</h2>
          <p>
          ...
          <h3 className="text-lg font-bold text-[#1B4E8A]">האם סורק OBD2 יכול להזיק לרכב?</h3>
          ...
          <h3 className="text-lg font-bold text-[#1B4E8A]">האם אני יכול להפעיל סורק OBD2 בעצמי בלי ידע טכני?</h3>
          <p>כן בהחלט. אפליקציות כמו Car Scanner ו-Torque מתורגמות לעברית ומסבירות כל קוד תקלה במילים פשוטות.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">לאיזה רכב לא מתאים סורק OBD2?</h3>
          <p>רכבים שיוצרו לפני 2001 (באירופה) או 1996 (בארה&quot;ב) — הם משתמשים ב-OBD1 שדורש סורק יצרן ספציפי.</p>

          <h3 className="text-lg font-bold text-[#1B4E8A]">מה ההבדל בין סורק לרכב למחשב הרכב?</h3>
