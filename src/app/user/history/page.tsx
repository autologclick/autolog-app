...
export default function HistoryPage() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[60vh] pt-12 lg:pt-0">
  ...
  return (
    <div className="space-y-6 pt-12 lg:pt-0" dir="rtl">
      ...
      <div className="flex items-center gap-3 px-3 sm:px-0">
        ...
        <h1 className="text-xl sm:text-2xl font-bold text-[#1e3a5f]">ציר הזמן</h1>
      </div>

      {/* Vehicle Selector and Type Filter - Mobile Stacked, Desktop Row */}
      <div className="px-3 sm:px-0 space-y-3 sm:space-y-0 sm:flex sm:gap-3">
        {/* Vehicle Selector */}
      ...
      {events.length === 0 ? (
        ...
        <div className="px-3 sm:px-0 relative">
