    ...
    <div className="min-h-screen bg-[#F3F6FA]" dir="rtl">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose-rtl space-y-6 text-gray-700 leading-relaxed text-[15px]">
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">מכוני בדיקה מומלצים בנתניה והשרון</h2>

          <h3 className="text-xl font-bold text-[#1B4E8A]">1. קומפיוטסט נתניה</h3>
          ...
          <h3 className="text-xl font-bold text-[#1B4E8A]">2. טכנו טסט נתניה</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
            <li><strong>מחיר:</strong> 680-870 ש&quot;ח</li>
            <li><strong>התמחות:</strong> חשמלי, היברידי</li>
          </ul>

          <h3 className="text-xl font-bold text-[#1B4E8A]">3. מבדק נתניה</h3>
          <ul className="list-disc list-inside space-y-1 mr-4">
            <li><strong>מחיר:</strong> 620-790 ש&quot;ח</li>
            <li><strong>שירות:</strong> בדיקה + שמאות בחבילה</li>
          </ul>

          <h3 className="text-xl font-bold text-[#1B4E8A]">4. מכון בדיקה כפר סבא (אלטרנטיבה קרובה)</h3>
          <p>תושבי כפר סבא, הוד השרון ורעננה — שווה לבדוק גם את המכון בכפר סבא. 10-15 דקות נסיעה מנתניה.</p>

          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">כמה עולה בנתניה?</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">דברים מיוחדים לבדוק ברכב מנתניה</h2>
          ...
          <h2 className="text-2xl font-bold text-[#1B4E8A] pt-4">המלצות לפי קריטריון</h2>
          <ul className="list-disc list-inside space-y-2 mr-4">
          ...
          <h3 className="text-lg font-bold text-[#1B4E8A]">איפה הכי זול בנתניה?</h3>
          <p>מבדק נתניה — סביב 620-790 ש&quot;ח לרכב פרטי.</p>
          <h3 className="text-lg font-bold text-[#1B4E8A]">האם תושבי הוד השרון יבואו לנתניה?</h3>
          <p>לרוב כפר סבא יותר נוחה — 10 דקות בלי פקקים.</p>
          <h3 className="text-lg font-bold text-[#1B4E8A]">כמה לוקחת בדיקה בנתניה?</h3>
